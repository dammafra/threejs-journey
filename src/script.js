...
gui.addColor(debugObject, 'colorA').onChange(value => uniforms.uColorA.value.set(value))
gui.addColor(debugObject, 'colorB').onChange(value => uniforms.uColorB.value.set(value))
